...
- (void)searchBarSearchButtonClicked:(UISearchBar *)searchBar
{
    ...
    [_weatherController getForecastAtZipcode:zipCodeSearchQuery completion:^(NSString *cityName, NSError *error) {
        if (error) {
            NSLog(@"Error fetching forecast for entered zip code: %@", error);
            return;
        }
